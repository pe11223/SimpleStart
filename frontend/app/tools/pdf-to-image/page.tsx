...
import { PdfToImage } from "@/components/ui/pdf-to-image";
  ...
  return (
    <main className="min-h-screen p-8 relative overflow-hidden bg-background">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-red-500/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        <header className="flex items-center gap-4 mb-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold tracking-tight">{t("pdfToImage")}</h1>
        ...
        >
          <div className="mb-6">
            <p className="text-foreground/60">{t("pdfToImageDesc")}</p>
          </div>
          <PdfToImage />
        </motion.div>
      </div>
